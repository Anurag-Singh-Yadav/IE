  ...
  return (
    <div className=" h-[90vh] background-grid -z-10">
      <div className="h-full flex flex-col gap-6 justify-center items-center circular-gradient-div z-10">
        ...
        <p className="sm:hidden text-center px-2">Master coding to shape your dreams and design a limitless future. Unleash creativity, turning lines of code into pathways to success.</p>
        <p className="hidden sm:flex text-center px-4 sm:mx-10 md:mx-20 lg:mx-44 lg:px-16 mb-4">Embark on a journey to transform your aspirations into reality through the art of coding. Learn to code your dreams and shape the blueprint of your future with creative design. Unleash the power of technology to bring your visions to life.</p>
