...
function CourseCard({course}) {
  return (
    <div className="shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] bg-white flex flex-col gap-3 rounded-lg overflow-hidden rounded-b-sm cursor-pointer">
      <Image
        src={course.img}
        alt={course.title}
      ...
      <div className="flex flex-col gap-2 justify-center px-6 pb-6 pt-4">
        ...
        <div className="flex gap-4 items-center">
          <p>
            <MdOutlineTimer size={20} className="text-green-bg inline mr-3" />
            <span>{course.duration}</span>
          </p>
          <p>
            <FaStar size={20} className="text-green-bg inline mr-3" />
            {course.rating}
          </p>
        </div>
        <p>
          <GiNetworkBars size={20} className="text-green-bg inline mr-3" />
