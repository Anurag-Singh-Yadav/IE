export const data = [
  ...
  },
  {
    ...
    questions:[
        {
          description: "Two ships are sailing in the sea on the two sides of a lighthouse. The angle of elevation of the top of the lighthouse is observed from the ships are 30° and 45° respectively. If the lighthouse is 100 m high, the distance between the two ships is:",
          options: ["173 m", "200 m", "273 m", "300 m"],
          answer: "273 m",
          explanation: "Let AB be the lighthouse and C and D be the positions of the ships. Then, AB = 100 m, ACB = 30° and ADB = 45°. AB = tan 30° = 1. AC = AB x √3 = 100√3 m. AB = tan 45° = 1. AD = AB = 100 m. CD = AC + AD = 100√3 + 100 m = 100(√3 + 1) m = (100 x 2.73) m = 273 m."
        },
        {
          description: "A man standing at a point P is watching the top of a tower, which makes an angle of elevation of 30° with the man's eye. The man walks some distance towards the tower to watch its top and the angle of the elevation becomes 60°. What is the distance between the base of the tower and the point P?",
        ...
        {
          description: "The angle of elevation of a ladder leaning against a wall is 60° and the foot of the ladder is 4.6 m away from the wall. The length of the ladder is:",
          options: ["2.3 m", "4.6 m", "7.8 m", "9.2 m"],
          answer: "9.2 m",
          explanation: "Let AB be the wall and BC be the ladder. Then, ACB = 60° and AC = 4.6 m. AC = cos 60° = 1 / 2. BC = 2 x AC = (2 x 4.6) m = 9.2 m."
        },
        {
          description: "An observer 1.6 m tall is 20√3 away from a tower. The angle of elevation from his eye to the top of the tower is 30°. The height of the tower is:",
          options: ["21.6 m", "23.2 m", "24.72 m", "None of these"],
          answer: "24.72 m",
          explanation: "Let AB be the observer and CD be the tower. Draw BE perpendicular to CD. Then, CE = AB = 1.6 m, BE = AC = 20√3 m. DE = tan 30° = 1 / √3. DE = 20√3 / √3 = 20 m. CD = CE + DE = (1.6 + 20) m = 21.6 m."
        },
        {
          description: "From a point P on a level ground, the angle of elevation of the top tower is 30°. If the tower is 100 m high, the distance of point P from the foot of the tower is:",
          options: ["149 m", "156 m", "173 m", "200 m"],
          answer: "173 m",
          explanation: "Let AB be the tower. Then, APB = 30° and AB = 100 m. AB = tan 30° = 1 / √3. AP = AB x √3 = 100√3 m = (100 x 1.73) m = 173 m."
        }
      ];
  },
  {
    ...
    questions:  [
        {
          description: "From a group of 7 men and 6 women, five persons are to be selected to form a committee so that at least 3 men are there on the committee. In how many ways can it be done?",
          options: ["564", "645", "735", "756"],
          answer: "756",
          explanation: "We may have (3 men and 2 women) or (4 men and 1 woman) or (5 men only). Required number of ways = (7C3 x 6C2) + (7C4 x 6C1) + (7C5) = 7 x 6 x 5 x 6 x 5 + (7C3 x 6C1) + (7C2) = (525 + 210 + 21) = 756."
        },
        {
  ...
  },
  {
    ...
    questions:[
        {
          statement: "Tanya is older than Eric. Cliff is older than Tanya. Eric is older than Cliff.",
        ...
        {
          statement: "Blueberries cost more than strawberries. Blueberries cost less than raspberries. Raspberries cost more than strawberries and blueberries.",
          options: ["true", "false", "uncertain"],
          correct: "true",
          explanation: "Because the first two statements are true, raspberries are the most expensive of the three."
        },
        {
          statement: "All the trees in the park are flowering trees. Some of the trees in the park are dogwoods. All dogwoods in the park are flowering trees.",
          options: ["true", "false", "uncertain"],
          correct: "true",
          explanation: "All of the trees in the park are flowering trees, So all dogwoods in the park are flowering trees."
        },
        {
          statement: "Mara runs faster than Gail. Lily runs faster than Mara. Gail runs faster than Lily.",
          options: ["true", "false", "uncertain"],
          correct: "false",
          explanation: "We know from the first two statements that Lily runs fastest. Therefore, the third statement must be false."
        },
        {
          statement: "Apartments in the Riverdale Manor cost less than apartments in The Gaslight Commons. Apartments in the Livingston Gate cost more than apartments in the The Gaslight Commons. Of the three apartment buildings, the Livingston Gate costs the most.",
          options: ["true", "false", "uncertain"],
          correct: "true",
  ...
  },
  {
    ...
    questions:[
        {
          statement: "One New York publisher has estimated that 50,000 to 60,000 people in the United States want an anthology that includes the complete works of William Shakespeare. And what accounts for this renewed interest in Shakespeare? As scholars point out, his psychological insights into both male and female characters are amazing even today.",
          options: ["Shakespeare's characters are more interesting than fictional characters today.", "people even today are interested in Shakespeare's work because of the characters.", "academic scholars are putting together an anthology of Shakespeare's work.", "New Yorkers have a renewed interested in the work of Shakespeare.", "Shakespeare was a psychiatrist as well as a playwright."],
          correct: "people even today are interested in Shakespeare's work because of the characters.",
        ...
        {
          statement: "One of the warmest winters on record has put consumers in the mood to spend money. Spending is likely to be the strongest in thirteen years. During the month of February, sales of existing single-family homes hit an annual record rate of 4.75 million.",
          options: ["consumer spending will be higher thirteen years from now than it is today.", "more people buy houses in the month of February than in any other month.", "during the winter months, the prices of single-family homes are the lowest.", "there were about 4 million homes for sale during the month of February.", "warm winter weather is likely to affect the rate of home sales."],
          correct: "warm winter weather is likely to affect the rate of home sales.",
          explanation: "This is clearly the best answer because the paragraph directly states that warm weather affects consumers inclination to spend. It furthers states that the sales of single-family homes was at an all-time high. There is no support for choice a or c. Choice b is wrong because even though there were high sales for a particular February, this does not mean that sales are not higher in other months. Choice d presents a misleading figure of 4 million. The paragraph states that the record of 4.75 million was at an annual, not a monthly, rate."
        },
        {
          statement: "Generation Xers are those people born roughly between 1965 and 1981. As employees, Generation Xers tend to be more challenged when they can carry out tasks independently. This makes Generation Xers the most entrepreneurial generation in history.",
          options: ["work harder than people from other generations.", "have a tendency to be self-directed workers", "have an interest in making history", "tend to work in jobs that require risk-taking behavior.", "like to challenge their bosses work attitudes."],
          correct: "have a tendency to be self-directed workers",
          explanation: "The support for choice b is given in the second sentence of the paragraph. Generation Xers like to work independently, which means they are self-directed. No support is given for either choice a or choice c. Choice d is not related to the paragraph. Although the paragraph mentions that Generation Xers like to be challenged, it does not say they like to challenge their bosses attitudes; therefore, choice e can be ruled out."
        },
        {
          ...
          options: ["fitness walking is a better form of exercise than weight lifting.", "a membership in a health club is a poor investment.", "walking outdoors provides a better workout than walking indoors.", "fitness walking is a convenient and valuable form of exercise.", "poorly designed athletic shoes can cause major foot injuries."],
          correct: "fitness walking is a convenient and valuable form of exercise.",
  ...
  },
  {
    ...
    questions:[
        ...
        {
          statement: "Look at this series: 7, 10, 8, 11, 9, 12, ... What number should come next?",
          options: ["7", "10", "12", "13"],
          correct: "10",
        ...
        {
          statement: "Look at this series: 36, 34, 30, 28, 24, ... What number should come next?",
          options: ["20", "22", "23", "26"],
          correct: "22",
          explanation: "This is an alternating number subtraction series. First, 2 is subtracted, then 4, then 2, and so on."
        },
        {
          statement: "Look at this series: 22, 21, 23, 22, 24, 23, ... What number should come next?",
          options: ["22", "24", "25", "26"],
          correct: "24",
          explanation: "In this simple alternating subtraction and addition series; 1 is subtracted, then 2 is added, and so on."
        },
        {
          statement: "Look at this series: 53, 53, 40, 40, 27, 27, ... What number should come next?",
          options: ["12", "14", "27", "53"],
          correct: "27",
